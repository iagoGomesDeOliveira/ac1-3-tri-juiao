...
function choose(produto) {
    switch (produto) {
        case 1:
            ...
            document.getElementById('preview').src = '/LanPage/lPage/abaca.png'
            break;
        case 2:
            document.getElementById('nome').innerHTML = 'Danone'
            document.getElementById('preview').src = '/LanPage/lPage/danonaoGrosso.png'
            break;
         case 3:
            document.getElementById('nome').innerHTML = 'Paçoca Coletiva'
            document.getElementById('preview').src =  '/LanPage/lPage/pacoca.png'
            break;
